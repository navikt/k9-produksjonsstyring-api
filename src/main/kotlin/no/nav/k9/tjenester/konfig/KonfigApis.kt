...
fun Route.KonfigApis() {
    ...
    val refreshUrlDev = "https://k9-los-oidc-auth-proxy.dev.adeo.no/api/k9-los-api/refresh"
    val refreshUrlProd = "https://k9-los-oidc-auth-proxy.nais.adeo.no/api/k9-los-api/refresh"
