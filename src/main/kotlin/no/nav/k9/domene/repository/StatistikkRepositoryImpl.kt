...
//
//@ApplicationScoped
//class StatistikkRepositoryImpl : StatistikkRepository {
//
...
//    }
//
//    override fun hentAlleOppgaverForAvdeling(avdelingEnhet: String): List<Array<Any>> {
...
//    }
//
//    override fun hentAlleOppgaverForAvdelingPerDato(avdelingEnhet: String): List<*> {
//        return entityManager.createNativeQuery(
...
//    }
//
//    override fun hentAntallOppgaverForAvdelingSattManueltPåVent(avdelingEnhet: String): List<*> {
...
//    }
//
//    override fun hentNyeOgFerdigstilteOppgaver(sakslisteId: Long?): List<*> {
//        val oppgaveFiltrering = entityManager.find(OppgaveFiltrering::class.java, sakslisteId)
//        val oppgavespørringDto = OppgavespørringDto(oppgaveFiltrering)
//
//        var filtrerBehandlingType =
//            if (oppgavespørringDto.behandlingTyper!!.isEmpty()) "" else " o.BEHANDLING_TYPE in ( :behtyper  ) AND "
//        var filtrerYtelseType =
//            if (oppgavespørringDto.ytelseTyper!!.isEmpty()) "" else " o.FAGSAK_YTELSE_TYPE in ( :fagsakytelsetype ) AND "
//
//        val filtrerInkluderAndreKriterier = StringBuilder()
//        for (andreKriterierType in oppgavespørringDto.inkluderAndreKriterierTyper!!) {
...
//        }
//
//        val filtrerEkskluderAndreKriterier = StringBuilder()
//        for (andreKriterierType in oppgavespørringDto.ekskluderAndreKriterierTyper!!) {
//            filtrerEkskluderAndreKriterier.append("NOT EXISTS (select 1 from OPPGAVE_EGENSKAP oen WHERE o.ID = oen.OPPGAVE_ID AND oen.aktiv = 'J' AND oen.ANDRE_KRITERIER_TYPE = '")
//                .append(andreKriterierType.getKode()).append("' ) AND ")
//        }
//
//        if (!oppgavespørringDto.behandlingTyper!!.isEmpty()) {
//            filtrerBehandlingType = filtrerBehandlingType
//                .replace(
//                    ":behtyper", oppgavespørringDto.behandlingTyper!!.stream()
//                        .map(Function<BehandlingType, Any> { BehandlingType.getKode() })
//                        .collect(Collectors.joining("','", "'", "'"))
//                )
//        }
//
//        if (!oppgavespørringDto.ytelseTyper!!.isEmpty()) {
//            filtrerYtelseType = filtrerYtelseType
//                .replace(
//                    ":fagsakytelsetype", oppgavespørringDto.ytelseTyper!!.stream()
//                        .map(Function<FagsakYtelseType, Any> { FagsakYtelseType.getKode() })
//                        .collect(Collectors.joining("','", "'", "'"))
//                )
//        }
//
...
//    }
//
//    override fun hentOppgaverPerFørsteStønadsdag(avdeling: String): List<*> {
//        return entityManager.createNativeQuery(
...
//    companion object {
//
//        private val AVDELING_ENHET = "avdelingEnhet"
//        private val TIL_BESLUTTER = "tilBeslutter"
//    }
//}
